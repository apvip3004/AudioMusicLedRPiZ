...
def up_level_show_1():
    global UP_LEVEL
    while True:
        strip.setPixelColor(UP_LEVEL,Color(0,0,0))
        UP_LEVEL -= 1
        strip.setPixelColor(UP_LEVEL,Color(0,LED_BRIGHTNESS,0))
        strip.show()
        time.sleep(0.2)

up_time_1 = threading.Timer(1.0, up_level_show_1)
